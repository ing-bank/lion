...
In order to leverage the provider system (separating logic from presentation, allowing to switch designs w/o rebuilding layouts/pages), reuse all the work from Pavlik. And later enhcance with provider system defined here: https://github.com/ing-bank/lion/tree/astro-poc-reference/src/design-providers 
