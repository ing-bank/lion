...
export default css`
  ...
  [data-part='listitem'][data-has-active-child] {
    font-weight: 600;
  ...
  [data-part='invoker-for-level']:hover {
    ...
    /* [data-part='anchor'], [data-part='invoker-for-level'] {
    position: relative;
  }
  
  [data-part='anchor']:hover::before, [data-part='invoker-for-level']:hover::before {
    content:'';
