 ...
 * @typedef {import('./LightRenderMixinTypes.js').LightRenderHost} LightRenderHost
 * @typedef {import('./LightRenderMixinTypes.js').SlotItem} SlotItem
 ...
 *
 *
 * @template {import('./LightRenderMixinTypes.js').Constructor<LitElement>} T
 * @param {T} superclass
 * @return {T & import('./LightRenderMixinTypes.js').Constructor<LightRenderHost>}
 *
 */
const LightRenderMixinImplementation = superclass =>
  /** @type {LightRenderHost} */
  (
    class LightRenderHost extends superclass {
      /**
       * @type {SlotItem[]}
       */
      slots = [];
