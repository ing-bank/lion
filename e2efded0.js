import{i as e,a as t,x as o}from"./b8bc2eda.js";import{s}from"./4afec9a2.js";class n{name="OverlayManager 1.x";blockBody=!1;constructor(){this._setupBlocker()}_setupBlocker(){const e=document.createElement("div");e.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 140px; text-align: center;"),e.innerText=`Blocker for ${this.name}`;document.getElementById("overlay-target").appendChild(e),this.blocker=e}block(){this.blockBody=!0,this.blocker.style.backgroundColor="#ff6161"}unBlock(){this.blockBody=!1,this.blocker.style.backgroundColor="transparent"}}let r,c;const a=document.createElement("div");a.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 140px; text-align: center;"),a.innerText="Shared Blocker for App",document.body.appendChild(a);r=new class extends n{constructor(){super(),this.name="Compatible1 from App"}block(e=!0){super.block(),e&&c.blockBody(!1)}unBlock(e=!0){super.unBlock(),e&&c.unBlockBody(!1)}_setupBlocker(){this.blocker=a}},c=new class extends n{constructor(){super(),this.name="Compatible2 from App"}blockBody(e=!0){super.blockBody(),e&&r.block()}unBlockBody(e=!0){super.unBlockBody(),e&&r.unBlock()}_setupBlocker(){this.blocker=a}},s.set("overlays::overlays::1.x",r),s.set("overlays::overlays::2.x",c);const l=s.get("overlays::overlays::1.x")||new n;customElements.define("page-a",class extends e{static get styles(){return t`
      :host {
        display: block;
        padding: 10px;
    ...
    `}render(){return o`
      ...
      <p>Overlays Status:</p>
      <p>Name: ${d.name}</p>
      <p>Blocked: ${d._blockBody}</p>
      <button @click=${()=>{d.blockBody(),this.requestUpdate()}}>block</button>
      <button @click=${()=>{d.unBlockBody(),this.requestUpdate()}}>un-block</button>
      <button @click=${()=>{this.requestUpdate()}}>refresh</button>
