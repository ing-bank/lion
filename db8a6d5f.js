import"./f1151d68.js";import{a as e,x as t,i as o}from"./b8bc2eda.js";import"./6638bb86.js";import{d as i}from"./962426a7.js";import{L as r}from"./ac7779e1.js";import{L as n}from"./777b51e0.js";import{L as s}from"./fd5951b6.js";import{r as a}from"./8df0a0f4.js";import"./4abf0ca8.js";import"./dc2f5f5a.js";import"./7c882590.js";import"./4afec9a2.js";import"./11b71ee2.js";import"./c48d90f3.js";import"./be5f2fd3.js";import"./dcadf410.js";import"./143fde17.js";import"./6722e641.js";import"./2cefa045.js";import"./af1609b4.js";import"./18551691.js";import"./4c616179.js";import"./acda6ea6.js";import"./0ed5d59c.js";import"./d924b319.js";import"./4dc0ac82.js";import"./5516584c.js";const l=i(o=>class extends o{static get styles(){return[...super.styles,e`
    ...
    `];get slots(){return{...super.slots,prefix:()=>a(t`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            ...
            ></path>
          </svg>`)}}constructor(){super(),this.opened=!0,this.showAllOnEmpty=!1,this.rotateKeyboardNavigation=!1}}customElements.define("wa-combobox",g);const u=i(e=>class extends e{static get properties(){return{href:String,target:String}}constructor(){super(),this._nativeAnchor=document.createElement("a")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","link")}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.__navigate),this.addEventListener("keydown",({key:e})=>{" "!==e&&"Enter"!==e||this.__navigate()})}updated(e){super.updated(e),e.has("href")&&(this._nativeAnchor.href=this.href),e.has("target")&&(this._nativeAnchor.target=this.target)}__navigate(){this._nativeAnchor.click()}});var f=t`
...
`;const _=new URL(new URL("a9adbd0d.png",import.meta.url).href,import.meta.url).href;class x extends(u(r)){static get properties(){return{imageUrl:{type:String}}}static get styles(){return[...super.styles,e`
      ...
      ${this.imageUrl?t` <img class="google-option__icon" src="${this.imageUrl}" alt="" />`:t` <div class="google-option__icon">${f}</div>`}
      ${super.render()}
    ...
    `}_googleSearchBtnsTemplate(){return t` <div class="google-search-btns">
      ...
      />
    </div>`}_groupTwoTemplate(){return t`${super._groupTwoTemplate()} ${this.opened?"":this._googleSearchBtnsTemplate()} `}get slots(){return{...super.slots,label:()=>a(t` <img alt="Google Search" src="${_}" style="width:auto; " />`),prefix:()=>a(t` <span>${f}</span> `),suffix:()=>a(t`
...
`,y=()=>{const e=new URL(new URL("3995b655.jpeg",import.meta.url).href,import.meta.url).href,o=new URL(new URL("fd054bdd.jpeg",import.meta.url).href,import.meta.url).href,i=new URL(new URL("6c21dd64.jpeg",import.meta.url).href,import.meta.url).href,r=new URL(new URL("f6bb77f2.jpeg",import.meta.url).href,import.meta.url).href,n=new URL(new URL("e5048dc1.jpeg",import.meta.url).href,import.meta.url).href;return t`
  ...
  `,$=document,T=[{key:"MaterialDesign",story:w},{key:"Github",story:v},{key:"Whatsapp",story:y},{key:"GoogleSearch",story:k}];let z=!1;for(const e of T){const t=$.querySelector(`[mdjs-story-name="${e.key}"]`);t&&(t.story=e.story,t.key=e.key,z=!0,Object.assign(t,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}z&&(customElements.get("mdjs-preview")||import("./e90784d0.js"),customElements.get("mdjs-story")||import("./0defd61d.js"));export{v as Github,k as GoogleSearch,w as MaterialDesign,y as Whatsapp};
