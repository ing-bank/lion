import{S as e}from"./08927fef.js";import{i as t,x as o}from"./b4be29f1.js";import"./05905ff1.js";import{L as n}from"./e0464e6e.js";import"./6722e641.js";class s extends(e(t)){static get scopedElements(){return{"lion-accordion":n}}render(){return o`
      <lion-accordion>
        <h3 slot="invoker">
    ...
    `}}customElements.define("my-component",s);const i=()=>o`<my-component></my-component>`,r=document,a=[{key:"overview",story:i}];let m=!1;for(const e of a){const t=r.querySelector(`[mdjs-story-name="${e.key}"]`);t&&(t.story=e.story,t.key=e.key,m=!0,Object.assign(t,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}m&&(customElements.get("mdjs-preview")||import("./24735558.js"),customElements.get("mdjs-story")||import("./cddf006a.js"));export{i as overview};
