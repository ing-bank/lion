...
></lion-input-range>`,s=()=>e`<lion-input-range
  ...
  .modelValue="${300}"
  label="Input range"
></lion-input-range>`,a=document,y=[{key:"HtmlStory15",story:i},{key:"HtmlStory16",story:l},{key:"HtmlStory17",story:m},{key:"HtmlStory18",story:s}];let r=!1;for(const n of y){const t=a.querySelector(`[mdjs-story-name="${n.key}"]`);t&&(t.story=n.story,t.key=n.key,r=!0,Object.assign(t,{simulatorUrl:"/next/simulator",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}r&&(customElements.get("mdjs-preview")||o(()=>import("./define.DSVRgKCR.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||o(()=>import("./define.DNIVKtom.js"),__vite__mapDeps([6,2,3])));export{i as HtmlStory15,l as HtmlStory16,m as HtmlStory17,s as HtmlStory18};
