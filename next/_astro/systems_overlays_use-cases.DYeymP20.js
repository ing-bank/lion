...
import{_ as d}from"./preload-helper.Cj2JEybs.js";import"./node-tools_providence-analytics_overview.BxIihMx7.js";import{i as v,a as p}from"./lit-element.jD9bOQKo.js";import{x as t}from"./lit-html.DtZEZPQ5.js";import"./unsafe-html.DgrA3nwU.js";import{O as y}from"./OverlayMixin.B6qUGSlE.js";import{A as b}from"./ArrowMixin.CJGmIkLg.js";import{w as c}from"./withBottomSheetConfig.Cflq9zAr.js";import{w as i}from"./withModalDialogConfig.CPyLhuB7.js";import{w as u}from"./withDropdownConfig.eRP55go6.js";import"./applyDemoOverlayStyles.jiEWGORD.js";import{n as a,e as s}from"./ref.Ce3g7EUE.js";class g extends v{static get styles(){return p`
      :host {
        top: 0;
        left: 0;
        width: 100%;
...
`,f=()=>{const e={...i()};return t`
  ...
  `},$=()=>{const e=s(),o=s(),n=r=>{switch(r){case"modaldialog":return{...i(),hasBackdrop:!0};case"bottomsheet":return{...c()};case"dropdown":return{...u(),hasBackdrop:!1,inheritsReferenceWidth:!0};default:return{...i(),hasBackdrop:!0}}},l=r=>{e.value.config=n(r.target.value)};return t`
    <style>
      .demo-overlay {
  ...
  `},C=()=>{const e={opened:!1},o={overlay:s(),openedState:s()};function n(l){e.opened=l.target.opened,o.openedState.value.innerText=e.opened}return t`
  ...
  `},E=()=>{let e=!0;const o={statusButton:s(),overlay:s()};function n(l){e&&l.preventDefault()}return t`
  ...
  `,S=()=>{const e={popperConfig:{placement:"right"}},o={popperConfig:{placement:"bottom"}},n={popperConfig:{placement:"left"}};class l extends b(y(v)){_defineOverlayConfig(){return{...super._defineOverlayConfig(),popperConfig:{...super._defineOverlayConfig().popperConfig,placement:"top"}}}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),this._overlayInvokerNode&&this._overlayInvokerNode.addEventListener("click",this.toggle)}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode&&this._overlayInvokerNode.removeEventListener("click",this.toggle)}}return customElements.get("arrow-example")||customElements.define("arrow-example",l),t`
    <style>
      .demo-box-placements {
        display: flex;
  ...
  `},D=document,L=[{key:"main",story:k},{key:"backdrop",story:f},{key:"backdropImperative",story:h},{key:"backdropAnimation",story:w},{key:"responsiveSwitching",story:x},{key:"responsiveSwitching2",story:$},{key:"openedState",story:C},{key:"interceptingOpenClose",story:E},{key:"overlayManager",story:_},{key:"localBackdrop",story:O},{key:"nestedOverlays",story:B},{key:"LocalWithArrow",story:S}];let m=!1;for(const e of L){const o=D.querySelector(`[mdjs-story-name="${e.key}"]`);o&&(o.story=e.story,o.key=e.key,m=!0,Object.assign(o,{simulatorUrl:"/next/simulator",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}m&&(customElements.get("mdjs-preview")||d(()=>import("./define.DSVRgKCR.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||d(()=>import("./define.DNIVKtom.js"),__vite__mapDeps([6,2,3])));export{S as LocalWithArrow,f as backdrop,w as backdropAnimation,h as backdropImperative,E as interceptingOpenClose,O as localBackdrop,k as main,B as nestedOverlays,C as openedState,_ as overlayManager,x as responsiveSwitching,$ as responsiveSwitching2};
