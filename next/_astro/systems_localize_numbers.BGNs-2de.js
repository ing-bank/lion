...
import{_ as l}from"./preload-helper.Cj2JEybs.js";import"./node-tools_providence-analytics_overview.BxIihMx7.js";import{a as c}from"./lit-element.jD9bOQKo.js";import{x as r}from"./lit-html.DtZEZPQ5.js";import"./unsafe-html.DgrA3nwU.js";import{f as e,a as m}from"./formatNumber.BZAJmq02.js";import{a as y}from"./all-locales.8DFhn3xF.js";const s=c`
  .demo-table {
...
`,h=document,f=[{key:"formatting",story:n},{key:"formattingParts",story:i},{key:"listCommonLocales",story:u},{key:"listAllLocales",story:b}];let a=!1;for(const t of f){const d=h.querySelector(`[mdjs-story-name="${t.key}"]`);d&&(d.story=t.story,d.key=t.key,a=!0,Object.assign(d,{simulatorUrl:"/next/simulator",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}a&&(customElements.get("mdjs-preview")||l(()=>import("./define.DSVRgKCR.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||l(()=>import("./define.DNIVKtom.js"),__vite__mapDeps([6,2,3])));export{n as formatting,i as formattingParts,b as listAllLocales,u as listCommonLocales};
