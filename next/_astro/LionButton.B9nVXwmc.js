import{i as r,a}from"./lit-element.qDHKJJma.js";import{x as l}from"./lit-html.C7L4dwLU.js";import{D as d}from"./DisabledWithTabIndexMixin.DiSGvuwH.js";const i=t=>t.key===" "||t.key==="Enter",n=t=>t.key===" ";class p extends d(r){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return l` <div class="button-content"><slot></slot></div> `}static get styles(){return[a`
        :host {
          position: relative;
          display: inline-flex;
