const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/bg-BG.Ctn9MZF9.js","_astro/bg.BwgOsKJm.js","_astro/cs-CZ.BI4RqpRh.js","_astro/cs.CrY8FRQv.js","_astro/de-DE.BKK8qAxt.js","_astro/de.Dp1aWnqF.js","_astro/en-AU.CKKojYlp.js","_astro/en.BLUCqhh8.js","_astro/en-GB.CKKojYlp.js","_astro/en-US.CKKojYlp.js","_astro/es-ES.DF3IEjPs.js","_astro/es.DRvr8sIr.js","_astro/fr-FR.ELWC_4mo.js","_astro/fr.DU6jAGXJ.js","_astro/fr-BE.ELWC_4mo.js","_astro/hu-HU.-45hF_MC.js","_astro/hu.BVQDnssO.js","_astro/id-ID.D-i0O1JO.js","_astro/id.DZUdbmow.js","_astro/it-IT.CGEoEoV5.js","_astro/it.CUlmotL0.js","_astro/nl-BE.CYXYQU9Z.js","_astro/nl.Ckb6gFxt.js","_astro/nl-NL.CYXYQU9Z.js","_astro/pl-PL.C0POvMRa.js","_astro/pl.Cnwx2cIx.js","_astro/ro-RO.Dd1TpCo9.js","_astro/ro.DRu4EZZ6.js","_astro/ru-RU.Crw68yyk.js","_astro/ru.BhV3PeXR.js","_astro/sk-SK.D9-Twote.js","_astro/sk.DoPVZKBl.js","_astro/uk-UA.BXFqnkM1.js","_astro/uk.Boxai4EX.js"])))=>i.map(i=>d[i]);
import{L as g}from"./LocalizeMixin.VYu75dkK.js";import{i as T,a as E}from"./lit-element.qDHKJJma.js";import{x as a,E as f}from"./lit-html.C7L4dwLU.js";import{o as L}from"./if-defined.CV50pAZo.js";import{d as v,L as x}from"./InteractionStateMixin.BJhuwH0C.js";import{V as D}from"./Validator.DAOhFpDH.js";import{g as w}from"./getLocalizeManager.W5d_ICRU.js";import{c as I}from"./repeat.BYpCtbkJ.js";import{_ as s}from"./preload-helper.4zY6-HO4.js";import{u as S}from"./uuid.DjYKNjre.js";import{L as N}from"./LionField.BWTJfyXr.js";class c extends D{static validatorName="IsAcceptedFile";static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf("."))}static isExtensionAllowed(e,t){return t?.find(i=>i.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(i=>i.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let i,l;const o=this.constructor,{allowedFileTypes:n,allowedFileExtensions:d,maxFileSize:h}=t;return n?.length?(i=e.some(u=>!o.isFileTypeAllowed(u.type,n)),i):d?.length?(l=e.some(u=>!o.isExtensionAllowed(o.getExtension(u.name),d)),l):e.findIndex(u=>!o.checkFileSize(u.size,h))>-1}static async getMessage(){return""}}class R extends D{static validatorName="DuplicateFileNames";constructor(e,t){super(e,t),this.type="info"}execute(e,t=this.param){return t.show}static async getMessage(){return w().msg("lion-input-file:uploadTextDuplicateFileName")}}const V=524288e3,F={type:"FILE_TYPE",size:"FILE_SIZE"},_={fail:"FAIL",pass:"SUCCESS"};class O{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf("."))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){const e=this._getFileNameExtension(this.systemFile.name);c.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=_.fail,this.failedProp.push(F.type))}else if(this._acceptCriteria.allowedFileTypes.length){const e=this.systemFile.type;c.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=_.fail,this.failedProp.push(F.type))}c.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==_.fail&&(this.status=_.pass):(this.status=_.fail,this.failedProp.push(F.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}}const y=r=>{switch(r){case"bg-BG":return s(()=>import("./bg-BG.Ctn9MZF9.js"),__vite__mapDeps([0,1]));case"bg":return s(()=>import("./bg.BwgOsKJm.js"),[]);case"cs-CZ":return s(()=>import("./cs-CZ.BI4RqpRh.js"),__vite__mapDeps([2,3]));case"cs":return s(()=>import("./cs.CrY8FRQv.js"),[]);case"de-DE":return s(()=>import("./de-DE.BKK8qAxt.js"),__vite__mapDeps([4,5]));case"de":return s(()=>import("./de.Dp1aWnqF.js"),[]);case"en-AU":return s(()=>import("./en-AU.CKKojYlp.js"),__vite__mapDeps([6,7]));case"en-GB":return s(()=>import("./en-GB.CKKojYlp.js"),__vite__mapDeps([8,7]));case"en-US":return s(()=>import("./en-US.CKKojYlp.js"),__vite__mapDeps([9,7]));case"en-PH":case"en":return s(()=>import("./en.BLUCqhh8.js"),[]);case"es-ES":return s(()=>import("./es-ES.DF3IEjPs.js"),__vite__mapDeps([10,11]));case"es":return s(()=>import("./es.DRvr8sIr.js"),[]);case"fr-FR":return s(()=>import("./fr-FR.ELWC_4mo.js"),__vite__mapDeps([12,13]));case"fr-BE":return s(()=>import("./fr-BE.ELWC_4mo.js"),__vite__mapDeps([14,13]));case"fr":return s(()=>import("./fr.DU6jAGXJ.js"),[]);case"hu-HU":return s(()=>import("./hu-HU.-45hF_MC.js"),__vite__mapDeps([15,16]));case"hu":return s(()=>import("./hu.BVQDnssO.js"),[]);case"id-ID":return s(()=>import("./id-ID.D-i0O1JO.js"),__vite__mapDeps([17,18]));case"id":return s(()=>import("./id.DZUdbmow.js"),[]);case"it-IT":return s(()=>import("./it-IT.CGEoEoV5.js"),__vite__mapDeps([19,20]));case"it":return s(()=>import("./it.CUlmotL0.js"),[]);case"nl-BE":return s(()=>import("./nl-BE.CYXYQU9Z.js"),__vite__mapDeps([21,22]));case"nl-NL":return s(()=>import("./nl-NL.CYXYQU9Z.js"),__vite__mapDeps([23,22]));case"nl":return s(()=>import("./nl.Ckb6gFxt.js"),[]);case"pl-PL":return s(()=>import("./pl-PL.C0POvMRa.js"),__vite__mapDeps([24,25]));case"pl":return s(()=>import("./pl.Cnwx2cIx.js"),[]);case"ro-RO":return s(()=>import("./ro-RO.Dd1TpCo9.js"),__vite__mapDeps([26,27]));case"ro":return s(()=>import("./ro.DRu4EZZ6.js"),[]);case"ru-RU":return s(()=>import("./ru-RU.Crw68yyk.js"),__vite__mapDeps([28,29]));case"ru":return s(()=>import("./ru.BhV3PeXR.js"),[]);case"sk-SK":return s(()=>import("./sk-SK.D9-Twote.js"),__vite__mapDeps([30,31]));case"sk":return s(()=>import("./sk.DoPVZKBl.js"),[]);case"uk-UA":return s(()=>import("./uk-UA.BXFqnkM1.js"),__vite__mapDeps([32,33]));case"uk":return s(()=>import("./uk.Boxai4EX.js"),[]);case"zh-CN":case"zh":return s(()=>import("./zh.DmRALI6n.js"),[]);default:return s(()=>import("./en.BLUCqhh8.js"),[])}};class k extends g(v(T)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":x}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":y},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has("fileList")&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){const e=this.shadowRoot?.querySelectorAll('[id^="file-feedback"]'),t=this.parentNode?.parentNode;e?.forEach(i=>{t?.addEventListener("focusin",()=>{i.setAttribute("aria-live","polite")}),t?.addEventListener("focusout",()=>{i.setAttribute("aria-live","assertive")})})}_removeFile(e){this.dispatchEvent(new CustomEvent("file-remove-requested",{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return a`
