import{i as n,a as c}from"./lit-element.jD9bOQKo.js";import{x as o}from"./lit-html.DtZEZPQ5.js";import{s as a}from"./index.BNCfcFQh.js";let l=class{name="OverlayManager 1.x";blockBody=!1;constructor(){this._setupBlocker()}_setupBlocker(){const e=document.createElement("div");e.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 140px; text-align: center;"),e.innerText=`Blocker for ${this.name}`,document.getElementById("overlay-target").appendChild(e),this.blocker=e}block(){this.blockBody=!0,this.blocker.style.backgroundColor="#ff6161"}unBlock(){this.blockBody=!1,this.blocker.style.backgroundColor="transparent"}};class d extends l{constructor(){super(),this.name="Compatible from App",this.blocker.innerText=`Blocker for ${this.name}`}blockingBody(){this.block()}unBlockingBody(){this.unBlock()}}const i=new d;a.set("overlays::overlays::1.x",i);a.set("overlays::overlays::2.x",i);const r=a.get("overlays::overlays::1.x")||new l;class u extends n{static get styles(){return c`
      :host {
        display: block;
        padding: 10px;
