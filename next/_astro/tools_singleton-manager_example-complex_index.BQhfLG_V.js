import{i as p,a as d}from"./lit-element.jD9bOQKo.js";import{x as o}from"./lit-html.DtZEZPQ5.js";import{s as c}from"./index.BNCfcFQh.js";let u=class{name="OverlayManager 1.x";blockBody=!1;constructor(){this._setupBlocker()}_setupBlocker(){const e=document.createElement("div");e.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 140px; text-align: center;"),e.innerText=`Blocker for ${this.name}`,document.getElementById("overlay-target").appendChild(e),this.blocker=e}block(){this.blockBody=!0,this.blocker.style.backgroundColor="#ff6161"}unBlock(){this.blockBody=!1,this.blocker.style.backgroundColor="transparent"}},n,l;const r=document.createElement("div");r.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 140px; text-align: center;");r.innerText="Shared Blocker for App";document.body.appendChild(r);class k extends u{constructor(){super(),this.name="Compatible1 from App"}block(e=!0){super.block(),e&&l.blockBody(!1)}unBlock(e=!0){super.unBlock(),e&&l.unBlockBody(!1)}_setupBlocker(){this.blocker=r}}class g extends u{constructor(){super(),this.name="Compatible2 from App"}blockBody(e=!0){super.blockBody(),e&&n.block()}unBlockBody(e=!0){super.unBlockBody(),e&&n.unBlock()}_setupBlocker(){this.blocker=r}}n=new k;l=new g;c.set("overlays::overlays::1.x",n);c.set("overlays::overlays::2.x",l);const a=c.get("overlays::overlays::1.x")||new u;class m extends p{static get styles(){return d`
      :host {
        display: block;
        padding: 10px;
