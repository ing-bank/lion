import{i as r,a}from"./lit-element.jD9bOQKo.js";import{x as l}from"./lit-html.DtZEZPQ5.js";import{D as d}from"./DisabledWithTabIndexMixin.DiSGvuwH.js";const i=t=>t.key===" "||t.key==="Enter",o=t=>t.key===" ";class f extends d(r){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return l` <div class="button-content"><slot></slot></div> `}static get styles(){return[a`
        :host {
          position: relative;
          display: inline-flex;
