...
</lion-checkbox-group>`,V=document,E=[{key:"HtmlStory5",story:x},{key:"HtmlStory6",story:_},{key:"HtmlStory7",story:g},{key:"HtmlStory8",story:p},{key:"event",story:y},{key:"HtmlStory9",story:f},{key:"HtmlStory10",story:S},{key:"HtmlStory11",story:C}];let h=!1;for(const s of E){const e=V.querySelector(`[mdjs-story-name="${s.key}"]`);e&&(e.story=s.story,e.key=s.key,h=!0,Object.assign(e,{simulatorUrl:"/next/simulator",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}h&&(customElements.get("mdjs-preview")||a(()=>import("./define.DSVRgKCR.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||a(()=>import("./define.DNIVKtom.js"),__vite__mapDeps([6,2,3])));export{S as HtmlStory10,C as HtmlStory11,x as HtmlStory5,_ as HtmlStory6,g as HtmlStory7,p as HtmlStory8,f as HtmlStory9,y as event};
