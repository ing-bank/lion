...
import{_ as t}from"./preload-helper.4zY6-HO4.js";import{S as r}from"./node-tools_providence-analytics_overview.DzUX1qVL.js";import{i as s}from"./lit-element.qDHKJJma.js";import{x as n}from"./lit-html.C7L4dwLU.js";import"./unsafe-html.J0GGe2Q7.js";import{L as a}from"./LionAccordion.DtIQ_atr.js";import"./directive.CGE4aKEl.js";import"./uuid.DjYKNjre.js";class m extends r(s){static get scopedElements(){return{"lion-accordion":a}}render(){return n`
      <lion-accordion>
        <h3 slot="invoker">
    ...
    `}}customElements.define("my-component",m);const d=()=>n`<my-component></my-component>`,l=document,c=[{key:"overview",story:d}];let i=!1;for(const e of c){const o=l.querySelector(`[mdjs-story-name="${e.key}"]`);o&&(o.story=e.story,o.key=e.key,i=!0,Object.assign(o,{simulatorUrl:"/next/simulator",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}i&&(customElements.get("mdjs-preview")||t(()=>import("./define.DAMBs0Wv.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||t(()=>import("./define.m2CvvXyF.js"),__vite__mapDeps([6,2,3])));export{d as overview};
