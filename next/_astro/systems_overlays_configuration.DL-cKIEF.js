...
import{_ as l}from"./preload-helper.Cj2JEybs.js";import"./node-tools_providence-analytics_overview.BxIihMx7.js";import"./lit-element.jD9bOQKo.js";import{x as t}from"./lit-html.DtZEZPQ5.js";import"./unsafe-html.DgrA3nwU.js";import"./applyDemoOverlayStyles.jiEWGORD.js";import{w as i}from"./withModalDialogConfig.CPyLhuB7.js";import{w as n}from"./withDropdownConfig.eRP55go6.js";import{w as c}from"./withTooltipConfig.CUfiDvGe.js";const a=()=>{const o={...n()};return t`
    <style>
      .demo-overlay {
  ...
  `,d=()=>{const o={...i(),isAlertDialog:!0};return t`
    <demo-el-using-overlaymixin .config="${o}">
  ...
  `},y=()=>{const o={...i(),hidesOnEsc:!1,hidesOnOutsideEsc:!1};return t`
    <demo-el-using-overlaymixin .config="${o}">
      <button slot="invoker">Click me to open the overlay!</button>
      <div slot="content" class="demo-overlay">
        Hello! You can close this notification here:
  ...
  `},g=()=>{const o={...n(),hidesOnOutsideEsc:!0};return t`
    <demo-el-using-overlaymixin .config="${o}">
      <button slot="invoker">Click me to open the overlay!</button>
      <div slot="content" class="demo-overlay">
        Hello! You can close this notification here:
  ...
  `},p=()=>{const o={...n(),hidesOnOutsideClick:!0};return t`
    <demo-el-using-overlaymixin .config="${o}">
      <button slot="invoker">Click me to open the overlay!</button>
      <div slot="content" class="demo-overlay">
  ...
  `,w=document,$=[{key:"placementLocal",story:a},{key:"placementGlobal",story:u},{key:"alertDialog",story:d},{key:"usingTooltipConfig",story:v},{key:"trapsKeyboardFocus",story:m},{key:"hidesOnEsc",story:b},{key:"hidesOnEscFalse",story:y},{key:"hidesOnOutsideEsc",story:g},{key:"hidesOnOutsideClick",story:p},{key:"elementToFocusAfterHide",story:h},{key:"hasBackdrop",story:f},{key:"isBlocking",story:k},{key:"preventsScroll",story:E},{key:"viewportConfig",story:C},{key:"popperConfig",story:x}];let s=!1;for(const o of $){const e=w.querySelector(`[mdjs-story-name="${o.key}"]`);e&&(e.story=o.story,e.key=o.key,s=!0,Object.assign(e,{simulatorUrl:"/next/simulator",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}s&&(customElements.get("mdjs-preview")||l(()=>import("./define.DSVRgKCR.js"),__vite__mapDeps([0,1,2,3,4,5])),customElements.get("mdjs-story")||l(()=>import("./define.DNIVKtom.js"),__vite__mapDeps([6,2,3])));export{d as alertDialog,h as elementToFocusAfterHide,f as hasBackdrop,b as hidesOnEsc,y as hidesOnEscFalse,p as hidesOnOutsideClick,g as hidesOnOutsideEsc,k as isBlocking,u as placementGlobal,a as placementLocal,x as popperConfig,E as preventsScroll,m as trapsKeyboardFocus,v as usingTooltipConfig,C as viewportConfig};
