/* eslint-disable */
import { html, render, css } from '@lion/core';
import '@lion/select-rich/lion-options.js';
import '@lion/select-rich/lion-select-rich.js';
import '@lion/option/lion-option.js';

import './packages/account/lion-account-option.js';
import './packages/account/lion-account-options.js';
import './packages/account/lion-account-select.js';
    ...
    <div class="demo-area">
      <lion-account-select label="Account" name="color">
        <lion-account-options
          ...
          @user-input-changed=${() => console.log('user input changed')}
          slot="input"
        >
          ${accounts.map(
            account => html`
              <lion-account-option .modelValue=${{ value: account.value, checked: false }}
                >${account.value.alias}</lion-account-option
              >
            `,
          )}
        </lion-account-options>
