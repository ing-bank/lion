import{i as e,a as t,x as o}from"./b8bc2eda.js";import{s}from"./4afec9a2.js";class n{name="OverlayManager 1.x";blockBody=!1;constructor(){this._setupBlocker()}_setupBlocker(){const e=document.createElement("div");e.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 140px; text-align: center;"),e.innerText=`Blocker for ${this.name}`;document.getElementById("overlay-target").appendChild(e),this.blocker=e}block(){this.blockBody=!0,this.blocker.style.backgroundColor="#ff6161"}unBlock(){this.blockBody=!1,this.blocker.style.backgroundColor="transparent"}}const r=new class extends n{constructor(){super(),this.name="Compatible from App",this.blocker.innerText=`Blocker for ${this.name}`}blockingBody(){this.block()}unBlockingBody(){this.unBlock()}};s.set("overlays::overlays::1.x",r),s.set("overlays::overlays::2.x",r);const a=s.get("overlays::overlays::1.x")||new n;customElements.define("page-e",class extends e{static get styles(){return t`
      :host {
        display: block;
        padding: 10px;
