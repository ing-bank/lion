import{i as l,a as i}from"./lit-element.qDHKJJma.js";import{x as t,B as a}from"./lit-html.C7L4dwLU.js";class s extends l{static get properties(){return{title:{type:String,reflect:!0},simple:{type:Boolean,reflect:!0},__logCounter:{type:Number}}}static get styles(){return[i`
        :host {
    ...
    `}__appendLog(e){const o=document.createElement("div");a(this._logTemplate(e),o),o.firstElementChild&&this.loggerEl.appendChild(o.firstElementChild)}__isConsecutiveDuplicateLog(e){return!!(this.loggerEl.lastElementChild&&this.loggerEl.lastElementChild.querySelector("code")?.textContent?.trim()===e)}__handleConsecutiveDuplicateLog(){this.loggerEl.lastElementChild?.querySelector(".logger__log-count")||this.__prependLogCounterElement();const e=this.loggerEl.lastElementChild?.querySelector(".logger__log-count");if(e instanceof HTMLElement){const o=e.textContent;if(o!=null){const r=parseInt(o,10)+1;e.innerText=r.toString()}}}__prependLogCounterElement(){const e=document.createElement("div");e.classList.add("logger__log-count"),e.innerText="1";const o=this.loggerEl.lastElementChild;o&&o.insertBefore(e,o.firstElementChild)}__animateCue(){const e=this.shadowRoot?.querySelector(".header__log-cue-overlay");e&&(e.classList.remove("header__log-cue-overlay--slide"),this.offsetWidth,e.classList.add("header__log-cue-overlay--slide"))}__clearLogs(){const e=this.shadowRoot?.querySelector(".logger");e&&(e.innerHTML="",this.__logCounter=0)}}window.customElements.define("sb-action-logger",s);
