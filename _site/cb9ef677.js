import"./24f95583.js";import{x as e}from"./b4be29f1.js";import"./05905ff1.js";import{i}from"./59b1489d.js";import{d as t}from"./d63d7fa1.js";import"./19d2607c.js";import"./4afec9a2.js";import"./11b71ee2.js";import"./953d28fa.js";i.addIconResolver("lion",(e,i)=>{if("misc"===e)return import("./1e82ba79.js").then(e=>e[i]);throw new Error(`Unknown iconset ${e}`)});const s=()=>e`
  <style>
    ${t}
  </style>
...
`,r=document,n=[{key:"top",story:s},{key:"right",story:l},{key:"opened",story:o},{key:"methods",story:u},{key:"events",story:a}];let c=!1;for(const e of n){const i=r.querySelector(`[mdjs-story-name="${e.key}"]`);i&&(i.story=e.story,i.key=e.key,c=!0,Object.assign(i,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}c&&(customElements.get("mdjs-preview")||import("./a7b4f51b.js"),customElements.get("mdjs-story")||import("./cddf006a.js"));export{a as events,u as methods,o as opened,l as right,s as top};
