 ...
 */
async function runFindCustomelementsSuite({ parser }) {
  setupAnalyzerTest();
  ...
  describe(`Analyzer "find-customelements" (${parser})`, async () => {
...
runFindCustomelementsSuite({ parser: 'oxc' });
runFindCustomelementsSuite({ parser: 'swc' });
