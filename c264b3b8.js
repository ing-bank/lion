import"./f1151d68.js";import{a as e,i as t,x as a}from"./b8bc2eda.js";import"./6638bb86.js";import{L as s}from"./21260aea.js";import"./6722e641.js";customElements.define("lea-tabs",class extends s{static get styles(){return[...super.styles,e`
        :host {
          background: #222;
          display: block;
          padding: 20px;
...
`,n=document,r=[{key:"main",story:o}];let l=!1;for(const e of r){const t=n.querySelector(`[mdjs-story-name="${e.key}"]`);t&&(t.story=e.story,t.key=e.key,l=!0,Object.assign(t,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}l&&(customElements.get("mdjs-preview")||import("./e90784d0.js"),customElements.get("mdjs-story")||import("./0defd61d.js"));export{o as main};
