...
```js preview-story
export const disabled = () => html` <lion-textarea-count label="Disabled" disabled></lion-textarea-count> `;
```
...
export const nonGrowing = () => html`
  <lion-textarea-count label="Non Growing" rows="3" max-rows="3"></lion-textarea-count>
`;
```
