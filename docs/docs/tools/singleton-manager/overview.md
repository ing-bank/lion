...
See [the code](https://github.com/ing-bank/lion/tree/master/packages/singleton-manager/demo/fail/demo-app.js).
...
and [the code](https://github.com/ing-bank/lion/tree/master/packages/singleton-manager/demo/singleton/demo-app.js).
...
and [the code](https://github.com/ing-bank/lion/tree/master/packages/singleton-manager/demo/singleton-complex/demo-app.js).
