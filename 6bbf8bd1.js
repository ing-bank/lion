import"./08927fef.js";import{i as e,a as o,x as t}from"./b4be29f1.js";import"./05905ff1.js";import{O as n}from"./9af64c94.js";import{A as i}from"./3371a831.js";import{w as l}from"./88061fcd.js";import{w as a}from"./c84885cc.js";import{w as r}from"./acda6ea6.js";import"./dfdd221f.js";import{n as s,e as c}from"./3ae224d1.js";import"./4afec9a2.js";import"./11b71ee2.js";import"./dc2f5f5a.js";import"./0ed5d59c.js";import"./52cbef17.js";import"./5516584c.js";import"./143fde17.js";import"./afb8834e.js";import"./19d2607c.js";customElements.define("demo-overlay-backdrop",class extends e{static get styles(){return o`
      :host {
        top: 0;
        left: 0;
        width: 100%;
...
`,v=()=>{const e={...a()};return t`
  ...
  `},y=()=>{const e=c(),o=c(),n=e=>{switch(e){case"modaldialog":default:return{...a(),hasBackdrop:!0};case"bottomsheet":return{...l()};case"dropdown":return{...r(),hasBackdrop:!1,inheritsReferenceWidth:!0}}};return t`
    <style>
      .demo-overlay {
  ...
  `},b=()=>{const e={opened:!1},o={overlay:c(),openedState:c()};return t`
  ...
  `},w=document,$=[{key:"main",story:d},{key:"backdrop",story:v},{key:"backdropImperative",story:m},{key:"backdropAnimation",story:u},{key:"responsiveSwitching",story:p},{key:"responsiveSwitching2",story:y},{key:"openedState",story:b},{key:"interceptingOpenClose",story:k},{key:"overlayManager",story:g},{key:"localBackdrop",story:f},{key:"nestedOverlays",story:h},{key:"LocalWithArrow",story:x}];let E=!1;for(const e of $){const o=w.querySelector(`[mdjs-story-name="${e.key}"]`);o&&(o.story=e.story,o.key=e.key,E=!0,Object.assign(o,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}E&&(customElements.get("mdjs-preview")||import("./24735558.js"),customElements.get("mdjs-story")||import("./cddf006a.js"));export{x as LocalWithArrow,v as backdrop,u as backdropAnimation,m as backdropImperative,k as interceptingOpenClose,f as localBackdrop,d as main,h as nestedOverlays,b as openedState,g as overlayManager,p as responsiveSwitching,y as responsiveSwitching2};
