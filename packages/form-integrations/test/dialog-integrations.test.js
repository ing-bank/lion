...
describe('Form inside dialog Integrations', () => {
  ...
  it('Successfully registers all form components when form is outside and fields are inside dialog', async () => {
    const el = /** @type {LionForm} */ await fixture(html`
    <lion-form>
        <form>
        <lion-dialog>
      <button slot="invoker">Open Dialog</button>
    ...
    const registeredEls = getAllTagNames(el);
