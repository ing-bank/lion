...
<Meta title="Localize System/Localize" />
...
<Story id="localize-system-extras--as-function" />
...
For use in a web component we have `LocalizeMixin` that let's you define namespaces and awaits loading of those translations.

<Story id="localize-system-extras--web-component" />
