...
<Meta title="Form Components/Input" parameters={{ component: 'lion-input' }} />
...
- Based on [field](?path=/docs/form-system-overview)
...
- Can make us of [validation](?path=/docs/form-system-validate-system)
...
The input can be used with [validation](?path=/docs/form-system-validate-system).
