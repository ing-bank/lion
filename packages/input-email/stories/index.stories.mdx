...
<Meta title="Form Components/Input Email" parameters={{ component: 'lion-input-email' }} />
...
- Makes use of email [validators](?path=/docs/form-system-validate-system) with corresponding error messages in different languages
  - IsEmail (default)
