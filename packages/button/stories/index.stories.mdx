...
<Story name="Icon">
  {html`<lion-button><lion-icon .svg="${bug12}"></lion-icon>Bug</lion-button>`}
</Story>

```html
<lion-button><lion-icon .svg="${bug12}"></lion-icon>Bug</lion-button>
```

### Icon only button

<Story name="Icon-only">
  {html`<lion-button aria-label="Bug"><lion-icon .svg="${bug12}"></lion-icon></lion-button>`}
</Story>

```html
<lion-button aria-label="Bug"><lion-icon .svg="${bug12}"></lion-icon></lion-button>
```
