...
import {
  ...
  LocalizeMixin,
  normalizeDateTime,
} from '@lion/components/localize.js';
    ...
    return [
      {
        'lion-calendar': /** @param {string} locale */ locale => {
          switch (locale) {
            case 'bg-BG':
            case 'bg':
              return import('@lion/components/calendar-translations/bg.js');
            case 'cs-CZ':
            case 'cs':
              return import('@lion/components/calendar-translations/cs.js');
            case 'de-AT':
            case 'de-DE':
            case 'de':
              return import('@lion/components/calendar-translations/de.js');
            case 'en-AU':
            case 'en-GB':
            case 'en-PH':
            case 'en-US':
            case 'en':
              return import('@lion/components/calendar-translations/en.js');
            case 'es-ES':
            case 'es':
              return import('@lion/components/calendar-translations/es.js');
            case 'fr-FR':
            case 'fr-BE':
            case 'fr':
              return import('@lion/components/calendar-translations/fr.js');
            case 'hu-HU':
            case 'hu':
              return import('@lion/components/calendar-translations/hu.js');
            case 'it-IT':
            case 'it':
              return import('@lion/components/calendar-translations/it.js');
            case 'nl-BE':
            case 'nl-NL':
            case 'nl':
              return import('@lion/components/calendar-translations/nl.js');
            case 'pl-PL':
            case 'pl':
              return import('@lion/components/calendar-translations/pl.js');
            case 'ro-RO':
            case 'ro':
              return import('@lion/components/calendar-translations/ro.js');
            case 'ru-RU':
            case 'ru':
              return import('@lion/components/calendar-translations/ru.js');
            case 'sk-SK':
            case 'sk':
              return import('@lion/components/calendar-translations/sk.js');
            case 'uk-UA':
            case 'uk':
              return import('@lion/components/calendar-translations/uk.js');
            case 'zh-CN':
            case 'zh':
              return import('@lion/components/calendar-translations/zh.js');
            default:
              return import('@lion/components/calendar-translations/en.js');
          }
        },
