    ...
    return [
      {
        'lion-pagination': /** @param {string} locale */ locale => {
          switch (locale) {
            case 'bg-BG':
              return import('@lion/components/pagination-translations/bg.js');
            case 'cs-CZ':
              return import('@lion/components/pagination-translations/cs.js');
            case 'de-AT':
            case 'de-DE':
              return import('@lion/components/pagination-translations/de.js');
            case 'en-AU':
            case 'en-GB':
            case 'en-PH':
            case 'en-US':
              return import('@lion/components/pagination-translations/en.js');
            case 'es-ES':
              return import('@lion/components/pagination-translations/es.js');
            case 'fr-FR':
            case 'fr-BE':
              return import('@lion/components/pagination-translations/fr.js');
            case 'hu-HU':
              return import('@lion/components/pagination-translations/hu.js');
            case 'it-IT':
              return import('@lion/components/pagination-translations/it.js');
            case 'nl-BE':
            case 'nl-NL':
              return import('@lion/components/pagination-translations/nl.js');
            case 'pl-PL':
              return import('@lion/components/pagination-translations/pl.js');
            case 'ro-RO':
              return import('@lion/components/pagination-translations/ro.js');
            case 'ru-RU':
              return import('@lion/components/pagination-translations/ru.js');
            case 'sk-SK':
              return import('@lion/components/pagination-translations/sk.js');
            case 'uk-UA':
              return import('@lion/components/pagination-translations/uk.js');
            case 'zh-CN':
              return import('@lion/components/pagination-translations/zh.js');
            default:
              return import('@lion/components/pagination-translations/en.js');
          }
        },
