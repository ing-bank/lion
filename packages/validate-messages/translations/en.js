export default {
  error: {
    ...
    MinNumber: 'Please enter a(n) {fieldName} not smaller than {params}.',
    MaxNumber: 'Please enter a(n) {fieldName} not larger than {params}.',
    MinMaxNumber: 'Please enter a(n) {fieldName} between {params.min} and {params.max}.',
    IsDate: 'Please enter a valid date (DD/MM/YYYY).',
    MinDate: 'Please enter a(n) {fieldName} not preceding {params, date, YYYYMMDD}.',
    MaxDate: 'Please enter a(n) {fieldName} not exceeding {params, date, YYYYMMDD}.',
    MinMaxDate:
