...
> Generated by `npm run skills:generate` from `docs/components/button` and `packages/ui/custom-elements.json`. Do not edit by hand — edit the source docs instead.
