...
1. Menus are not always overlays (same holds for selects and comboboxes).Although often an overlay, a menu can be defined in the document flow as well: - a menu inside a left dialog sheet/ sidebar - a combobox like: <https://lion-web-components.netlify.app/?path=/docs/forms-combobox-extensions--whatsapp>Concretely, this means that the disclosure
