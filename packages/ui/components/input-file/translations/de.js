export default {
  ...
  statusLoading: 'Dateien werden hochgeladen. Bitte warten.',
  statusSuccess: 'Die Datei {fileName} wurde erfolgreich hinzugefügt.',
  statusRemoved: 'Die Datei {fileName} wurde erfolgreich entfernt.',
};
