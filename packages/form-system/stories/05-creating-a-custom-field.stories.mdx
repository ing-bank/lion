...
<Meta title="Form Fundaments/Creating a Custom Field" />
...
validation support and get all the other [benefits of LionField](/?path=/docs/form-fundaments-overview--page).
...
[`modelValue`](?path=/docs/form-fundaments-modelvalue--page) of `<my-slider>`. Now the cycle is complete: the modelValue connects
