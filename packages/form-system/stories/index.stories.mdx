...
<Meta title="Form Components/Form System" />
...
- Built in [validate](?path=/docs/form-system-validate-system) for error/warning/info/success
...
| Package                                                      | Description                        |
| ------------------------------------------------------------ | ---------------------------------- |
| [checkbox](?path=/docs/form-components-checkbox)             | Checkbox form element              |
| [checkbox-group](?path=/docs/form-components-checkbox-group) | Group of checkboxes                |
| [field](?path=/docs/form-components-field)                   | Base class for all inputs          |
| [form](?path=/docs/form-components-form)                     | Wrapper for multiple form elements |
| [input](?path=/docs/form-components-input)                   | Input element for strings          |
| [input-amount](?path=/docs/form-components-input-amount)     | Input element for amounts          |
| [input-date](?path=/docs/form-components-input-date)         | Input element for dates            |
| [input-email](?path=/docs/form-components-input-email)       | Input element for e-mails          |
| [input-iban](?path=/docs/form-components-input-iban)         | Input element for IBANs            |
| [radio](?path=/docs/form-components-radio)                   | Radio form element                 |
| [radio-group](?path=/docs/form-components-radio-group)       | Group of radios                    |
| [select](?path=/docs/form-components-select)                 | Simple native dropdown element     |
| [textarea](?path=/docs/form-components-textarea)             | Multiline text input               |
| [validate](?path=/docs/form-system-validate-system)          | Validation for our form components |
