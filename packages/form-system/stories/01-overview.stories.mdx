...
`Form control`s are the most fundamental building block of our Form System.
...
They extend `LionField`, which on its turn uses the `FormControlMixin`.
...
Platform field wrapper add all of the functionality described above to form elements natively
...
Instead of wrapping native elements, this category of fields addresses custom built
form elements.
