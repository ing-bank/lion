...
- Standard flow, where a user changes the input with their keyboard
- Unparseable flow, where a user sets the input to something that is not parseable by the parser
- Imperative / programmatic flow, where the developer sets the modelValue of the input programmatically
