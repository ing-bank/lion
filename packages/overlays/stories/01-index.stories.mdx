...
<Meta title="Overlay System/Overview" parameters={{ component: 'lion-demo-overlay' }} />
...
We also export a few preset configuration objects, which you can find [here](?path=/docs/overlay-system-configuration).
