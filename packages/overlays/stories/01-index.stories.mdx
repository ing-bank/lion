...
Now, we will go in depth into the three main layers of our overlay system:
...
It is possible to intercept the open/close by making sure you fire `Event.preventDefault();` on
