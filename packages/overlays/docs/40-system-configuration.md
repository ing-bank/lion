...
### Migrating from Popper version 1

Previous versions of lion local overlays used Popper v1.
Please consult [Popper Migration Guide](https://popper.js.org/docs/v2/migration-guide/) when
migrating from Popper1.
Eventually, the `convertPopperConfig` function could be used to ease migration
(note that it only handles px values for offsets).

[Popper.js API](https://popper.js.org/docs/v1/)
