...
describe('lion-transfer', () => {
  ...
  it('select first option in left listboox and tranfer it to right listbox', () => {
    ...
    const transferToRightAction = /** @type {HTMLElement} */ (element.shadowRoot?.querySelector('slot[name="transferToRightActionSlot"]'));
  ...
  it('select second option in right listboox and tranfer it to left listbox', () => {
    ...
    const transferToLeftAction = /** @type {HTMLElement} */ (element.shadowRoot?.querySelector('slot[name="transferToLeftActionSlot"]'));
