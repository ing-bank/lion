...
<Meta title="Form Components/Checkbox Group" parameters={{ component: 'lion-checkbox-group' }} />
...
> Make sure that the checkbox-group also has a name attribute, this is necessary for the [lion-form](?path=/docs/form-components-form)'s serialization result.
