...
<Meta title="Form Components/Radio Group" parameters={{ component: 'lion-radio-group' }} />
...
- Make sure that to use a name attribute as it is necessary for the [lion-form](?path=/docs/form-components-form)'s serialization result.
- If you have many options for a user to pick from, consider using [lion-select](?path=/docs/form-components-select) instead

## Features

Since it extends from [lion-fieldset](?path=/docs/form-components-fieldset), it has all the features a fieldset has.
