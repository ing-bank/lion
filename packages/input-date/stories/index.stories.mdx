...
<Meta title="Form components/Input Date" parameters={{ component: 'lion-input-date' }} />
...
- Based on [lion-input](?path=/docs/form-components-input)
- Makes use of [formatDate](?path=/docs/localize-system-dates) for formatting and parsing.
- Option to override locale to change the formatting and parsing
- Default label in different languages
- Can make use of date specific [validators](?path=/docs/form-system-validate-system) with corresponding error messages in different languages
  - IsDate (default)
  - MinDate
  - MaxDate
  - MinMaxDate
