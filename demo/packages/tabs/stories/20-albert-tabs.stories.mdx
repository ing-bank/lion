...
import '../albert-tabs.js';
import '../albert-tab.js';
import '../albert-tab-panel.js';

<Meta title="Intro/Tabs Example" parameters={{ component: 'albert-tabs' }} />
...
`albert-tabs` implements tabs view to allow users to quickly move between a small number of equally important views.

<Preview>
  <Story name="default">
    {html`
      <albert-tabs>
        <albert-tab slot="tab">Info</albert-tab>
        <albert-tab-panel slot="panel">
          Info page with lots of information about us.
        </albert-tab-panel>
        <albert-tab slot="tab">Work</albert-tab>
        <albert-tab-panel slot="panel">
...
```js
import '@lion/tabs/albert-tabs.js';
```
...
This means you can switch the grouping in your `albert-tabs` from tab + panel to all tabs first or all panels first.
...
<Story name="Distribute new elements">
  {() => {
    const tagName = 'albert-tabs-experimental';
        ...
        class extends LitElement {
          ...
          render() {
            return html`
              ...
              <albert-tabs id="appendTabs">
                <albert-tab slot="tab">tab 1</albert-tab>
                <albert-tab-panel slot="panel">panel 1</albert-tab-panel>
                <albert-tab slot="tab">tab 2</albert-tab>
                <albert-tab-panel slot="panel">panel 2</albert-tab-panel>
              </albert-tabs>
              <hr />
              <h3>Push</h3>
              ...
              <albert-tabs id="pushTabs">
                ...
                ${this.__collection.map(
                  item => html`
                    <albert-tab slot="tab">${item.button}</albert-tab>
                    <albert-tab-panel slot="panel">${item.panel}</albert-tab-panel>
                  `,
                )}
              </albert-tabs>
            `;
          ...
          __handleAppendClick() {
            ...
            for (let i = n + 1; i < n + c; i += 1) {
              const tab = document.createElement('albert-tab');
              tab.setAttribute('slot', 'tab');
              tab.innerText = `tab ${i}`;
              const panel = document.createElement('albert-tab-panel');
    ...
    return html`
      <albert-tabs-experimental></albert-tabs-experimental>
    `;
  }}
</Story>
...
Inside your `albert-tabs` extension, an example for appending nodes on a certain button click:
