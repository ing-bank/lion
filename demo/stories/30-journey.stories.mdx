...
One of the big reasons why it is usually impossible to have multiple major versions of the same component is a technical one; the CustomElementsRegistry is global, and registering the same element twice under the same name is impossible.
