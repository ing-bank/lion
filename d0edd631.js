import{i as t,a as e,x as o}from"./b8bc2eda.js";const n=new class{name="OverlayManager 1.x";blockBody=!1;constructor(){this._setupBlocker()}_setupBlocker(){const t=document.createElement("div");t.setAttribute("style","border: 2px solid #8d0606; margin: 10px; padding: 10px; width: 180px; text-align: center;"),t.innerText=`Blocker for ${this.name}`;document.getElementById("overlay-target").appendChild(t),this.blocker=t}block(){this.blockBody=!0,this.blocker.style.backgroundColor="#ff6161"}unBlock(){this.blockBody=!1,this.blocker.style.backgroundColor="transparent"}};customElements.define("page-c",class extends t{static get styles(){return e`
      :host {
        display: block;
        padding: 10px;
