import"./f1151d68.js";import{x as t}from"./b8bc2eda.js";import"./6638bb86.js";import"./2d16d3c3.js";import"./c48d90f3.js";import"./be5f2fd3.js";import"./dcadf410.js";import"./7c882590.js";import"./4afec9a2.js";import"./11b71ee2.js";import"./dc2f5f5a.js";const e=()=>t` <lion-pagination count="20"></lion-pagination> `,n=()=>t` <lion-pagination></lion-pagination> `,o=({shadowRoot:e})=>(setTimeout(()=>{e.getElementById("pagination-method-demo").innerText=e.getElementById("pagination-method").current}),t`
  ...
  `),i=({shadowRoot:e})=>(setTimeout(()=>{e.getElementById("pagination-event-demo-text").innerText=e.getElementById("pagination-event-demo").current}),t`
    ...
    ></lion-pagination>
  `),a=document,r=[{key:"withoutCurrentPage",story:e},{key:"ensureCount",story:n},{key:"methods",story:o},{key:"event",story:i}];let m=!1;for(const t of r){const e=a.querySelector(`[mdjs-story-name="${t.key}"]`);e&&(e.story=t.story,e.key=t.key,m=!0,Object.assign(e,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}m&&(customElements.get("mdjs-preview")||import("./e90784d0.js"),customElements.get("mdjs-story")||import("./0defd61d.js"));export{n as ensureCount,i as event,o as methods,e as withoutCurrentPage};
