import{i as e,a as t,x as s}from"./b4be29f1.js";import{u as i}from"./6722e641.js";function n(e){e.removeAttribute("selected")}function d(e){e.removeAttribute("selected"),e.setAttribute("aria-selected","false"),e.setAttribute("tabindex","-1")}function r(e){const t=e;switch(t.key){case"ArrowDown":case"ArrowRight":case"ArrowUp":case"ArrowLeft":case"Home":case"End":t.preventDefault()}}class a extends e{static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",reflect:!0}}}static get styles(){return[t`
        .tabs__tab-group {
          display: flex;
        }
