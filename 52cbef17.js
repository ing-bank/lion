import{i as e,x as t,a as s}from"./b4be29f1.js";import{D as i}from"./5516584c.js";const n=e=>" "===e.key||"Enter"===e.key,o=e=>" "===e.key;class r extends(i(e)){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return t` <div class="button-content"><slot></slot></div> `}static get styles(){return[s`
        :host {
          position: relative;
          display: inline-flex;
