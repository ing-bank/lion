import"./24f95583.js";import{i as o,a as e,x as t,E as i}from"./b4be29f1.js";import{c as l}from"./c9978b47.js";import"./05905ff1.js";import{l as n,a as s,b as a}from"./2758bd27.js";import"./09750da9.js";import"./4de68b8d.js";import"./8763e36e.js";import{l as c}from"./c85cfbca.js";import{L as r}from"./9b4d17c9.js";import{R as m}from"./cc85a6f4.js";import"./19d2607c.js";import"./afb8834e.js";import"./5287c897.js";import"./5516584c.js";import"./143fde17.js";import"./dc2f5f5a.js";import"./b494bfc1.js";import"./7902d8e0.js";import"./d45984a3.js";import"./4afec9a2.js";import"./11b71ee2.js";import"./4cc99b59.js";import"./0bf7a48d.js";import"./48b0a907.js";import"./130d2801.js";import"./459b1eec.js";import"./4dc0ac82.js";import"./48ac1cb5.js";import"./e49751c9.js";import"./b7f85193.js";import"./622cc741.js";import"./a06c5caf.js";import"./65cdf028.js";import"./acda6ea6.js";import"./0ed5d59c.js";function p(o,e,t,i,l){return o<e||t<e?o>t?t+1:o+1:i===l?e:e+1}customElements.define("demo-selection-display",class extends o{static get properties(){return{comboboxElement:Object,removeChipOnNextBackspace:Boolean,selectedChoices:Array}}static get styles(){return e`
      :host {
        display: flex;
      }
    ...
    `:i}render(){return t` ${this._selectedElementsTemplate()} `}__textboxOnKeyup(o){"Backspace"===o.key?this._inputNode.value||(this.removeChipOnNextBackspace&&this.selectedChoices.length&&(this.comboboxElement.modelValue=this.selectedChoices.slice(0,-1)),this.removeChipOnNextBackspace=!0):this.removeChipOnNextBackspace=!1}__restoreBackspace(){this.removeChipOnNextBackspace=!1}}),c();const b=()=>t`
...
`,g=()=>t`
  <lion-combobox
    ...
    .matchCondition="${({choiceValue:o},e)=>{const t=o.toLowerCase(),i=e.toLowerCase();return t.slice(0,1)===i.slice(0,1)&&function(o,e){if(o===e)return 0;if(o.length>e.length){var t=o;o=e,e=t}for(var i=o.length,l=e.length;i>0&&o.charCodeAt(i-1)===e.charCodeAt(l-1);)i--,l--;for(var n=0;n<i&&o.charCodeAt(n)===e.charCodeAt(n);)n++;if(l-=n,0===(i-=n)||l<3)return l;var s,a,c,r,m,b,d,h,u,y,x,$,g=0,f=[];for(s=0;s<i;s++)f.push(s+1),f.push(o.charCodeAt(n+s));for(var k=f.length-1;g<l-3;)for(u=e.charCodeAt(n+(a=g)),y=e.charCodeAt(n+(c=g+1)),x=e.charCodeAt(n+(r=g+2)),$=e.charCodeAt(n+(m=g+3)),b=g+=4,s=0;s<k;s+=2)a=p(d=f[s],a,c,u,h=f[s+1]),c=p(a,c,r,y,h),r=p(c,r,m,x,h),b=p(r,m,b,$,h),f[s]=b,m=r,r=c,c=a,a=d;for(;g<l;)for(u=e.charCodeAt(n+(a=g)),b=++g,s=0;s<k;s+=2)d=f[s],f[s]=b=p(d,a,b,u,f[s+1]),a=d;return b}(t,i)<3}}"
  >
    ${n(s.map(o=>t` <lion-option .choiceValue="${o}">${o}</lion-option> `))}
  </lion-combobox>
