import"./08927fef.js";import{x as t}from"./b4be29f1.js";import"./05905ff1.js";import"./c4c2546b.js";import"./4cc99b59.js";import"./19d2607c.js";import"./afb8834e.js";import"./d45984a3.js";import"./4afec9a2.js";import"./11b71ee2.js";import"./dc2f5f5a.js";const e=()=>t` <lion-pagination count="20"></lion-pagination> `,n=()=>t` <lion-pagination></lion-pagination> `,o=({shadowRoot:e})=>(setTimeout(()=>{e.getElementById("pagination-method-demo").innerText=e.getElementById("pagination-method").current}),t`
  ...
  `),i=({shadowRoot:e})=>(setTimeout(()=>{e.getElementById("pagination-event-demo-text").innerText=e.getElementById("pagination-event-demo").current}),t`
    ...
    ></lion-pagination>
  `),a=document,r=[{key:"withoutCurrentPage",story:e},{key:"ensureCount",story:n},{key:"methods",story:o},{key:"event",story:i}];let m=!1;for(const t of r){const e=a.querySelector(`[mdjs-story-name="${t.key}"]`);e&&(e.story=t.story,e.key=t.key,m=!0,Object.assign(e,{simulatorUrl:"/simulator/",languages:[{key:"de-DE",name:"German"},{key:"en-GB",name:"English (United Kingdom)"},{key:"en-US",name:"English (United States)"},{key:"nl-NL",name:"Dutch"}]}))}m&&(customElements.get("mdjs-preview")||import("./24735558.js"),customElements.get("mdjs-story")||import("./cddf006a.js"));export{n as ensureCount,i as event,o as methods,e as withoutCurrentPage};
