...
test('Combobox does not flash the menu when _showOverlayCondition returns "false"', async ({ page }) => {
  await page.goto('http://localhost:8000/simulator/#?story-file=components%2Fcombobox%2Fuse-cases%2F__mdjs-stories&story-key=complexChoiceValue&theme=light&platform=web&language=en-US&edge-distance=true');
